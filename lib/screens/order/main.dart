                  ...
                  child: Wrap(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const NotoText('주문자', size: 16, color: Colors.black),
                          SizedBox(
                            width: 70,
                            height: 30,
                            child:
                                SmallButtonBox(title: '수정하기', onPressed: () {}),
                          ),
                        ],
                      ),
                      Row(
                        children: const [
                          ...
                          SizedBox(width: 20),
                          NotoText('userName', size: 14, color: Colors.black),
                        ],
                      ),
                      Row(
                        children: const [
                      ...
                      Row(
                        children: const [
                          SizedBox(
                            width: 60,
                            child: NotoText('이메일', size: 14, color: greyColor),
                          ),
                          SizedBox(width: 20),
                  ...
                  GestureDetector(
                    ...
                    child: BoxContainer(
                      ...
                      child: Container(
                        ...
                        child: const NotoText('결제하기', size: 14, isBold: true),
                      ),
                    ),
                  ),
                ],
