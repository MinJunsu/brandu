...
import 'package:brandu/viewmodels/profile/info/service/inquiry/modify.dart';
import 'package:brandu/widgets/appbar.dart';
import 'package:brandu/widgets/base/button.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class InquiryModifyPage extends GetView<InquiryModifyController> {
  const InquiryModifyPage({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: ButtonBox(
                  title: '삭제하기',
                  onPressed: controller.deleteInquiry,
                ),
              ),
            ],
          ),
